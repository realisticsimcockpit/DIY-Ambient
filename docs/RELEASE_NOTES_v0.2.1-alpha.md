...
- extinction à la fermeture de SimHub par défaut, avec option de conservation de la dernière couleur.

## Installation

1. Fermer SimHub.
2. Copier `DIYAmbient.Plugin.dll` dans le dossier d'installation de SimHub, à côté de `SimHubWPF.exe`.
3. Relancer SimHub et ouvrir **DIY Ambient light EVO**.

Cette version est une alpha. La sortie Adalight ne fournit aucun accusé de réception matériel. La limitation de courant est un modèle logiciel, pas une mesure électrique.
